...
elgg_register_event_handler('init', 'system', 'notification');

function notification() {

	// registers then loads the library for this module
	elgg_register_library('c_notify_msg', elgg_get_plugins_path().'notification/lib/functions.php');
	elgg_load_library('c_notify_msg');

	$action_path = elgg_get_plugins_path().'notification/actions';
	...
	if (elgg_is_active_plugin('html_email_handler') || elgg_get_plugin_setting("notifications","html_email_handler") == "yes") {
		set_view_location("html_email_handler/notification/body", elgg_get_plugins_path().'notification/views/');
